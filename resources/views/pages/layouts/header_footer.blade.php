            ...
            <li><a href="{{route('shop')}}">Shop</a></li>
                <li><a href="#">Pages</a>
                    ...
                    <li><a href="{{route('shop_details')}}">Shop Details</a></li>
                        <li><a href="{{route('shopping_cart')}}">Shoping Cart</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li><a href="#"><i class="fa fa-heart"></i> <span>1</span></a></li>
                            <li><a href="{{route('shopping_cart')}}"><i class="fa fa-shopping-bag"></i> <span>3</span></a></li>
                        </ul>
                        <div class="header__cart__price">item: <span>$150.00</span></div>
                    </div>
                </div>
...
@yield('index-content')
@yield('shop-content')
@yield('shop_details-conent')
@yield('shopping_cart-content')
